  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% Statische_Kennlinie_P.V_Step_Time
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% Statische_Kennlinie_P.V_Step_Y0
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 1;
	
	  ;% Statische_Kennlinie_P.V_Step_YFinal
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 2;
	
	  ;% Statische_Kennlinie_P.V_Step_Time_p
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 3;
	
	  ;% Statische_Kennlinie_P.V_Step_Y0_d
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 4;
	
	  ;% Statische_Kennlinie_P.V_Step_YFinal_a
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% Statische_Kennlinie_B.Add2
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% Statische_Kennlinie_B.Add
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 1;
  ...
  targMap.checksum0 = 2271890356;
  targMap.checksum1 = 106342308;
  targMap.checksum2 = 3399039307;
  targMap.checksum3 = 3782860742;
