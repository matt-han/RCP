...
MODEL               = Statische_Kennlinie
MODULES_OBJ         = Statische_Kennlinie_data.obj 
MAKEFILE            = Statische_Kennlinie.mk
...
TID01EQ             = 1
NCSTATES            = 0
BUILDARGS           =  GENERATE_REPORT=0 TMW_EXTMODE_TESTING=0 MODELLIB=Statische_Kennlinielib.lib RELATIVE_PATH_TO_ANCHOR=.. MODELREF_TARGET_TYPE=NONE
MULTITASKING        = 0
EXT_MODE            = 1
EXTMODE_TRANSPORT   = 0
EXTMODE_STATIC      = 1
...
# Additional includes
ADD_INCLUDES = &
C:\DOKUME~1\Student\EIGENE~1\MATLAB\LABORG~2\02_STA~1\STATIS~1;&
