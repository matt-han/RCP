...
MODEL               = regler_strecke_zwei
MODULES_OBJ         = regler_strecke_zwei_data.obj 
MAKEFILE            = regler_strecke_zwei.mk
...
TID01EQ             = 1
NCSTATES            = 1
BUILDARGS           =  GENERATE_REPORT=0 TMW_EXTMODE_TESTING=0 MODELLIB=regler_strecke_zweilib.lib RELATIVE_PATH_TO_ANCHOR=.. MODELREF_TARGET_TYPE=NONE
MULTITASKING        = 0
EXT_MODE            = 1
EXTMODE_TRANSPORT   = 0
EXTMODE_STATIC      = 0
...
# Additional includes
ADD_INCLUDES = &
C:\DOKUME~1\Student\EIGENE~1\MATLAB\LABORG~2\08_REG~1\REGLER~2;&
C:\DOKUME~1\Student\EIGENE~1\MATLAB\LABORG~2\08_REG~1;&
